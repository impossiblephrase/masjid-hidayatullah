...
export const TRANSLATIONS = {
  ...
  ko: {
    ...
    about_vision:   "공동체를 역량있게 하는 모범적이고 번영하는 이슬람 문명의 중심 마스지드가 되는 것.",
    ...
    programs_eyebrow: "활동",
    programs_title1:  "마스지드",
    programs_title2:  "프로그램",
    ...
    koperasi_desc:      "마스지드 히다야툴라는 지역사회 경제와 마스지드 운영을 지원하기 위해 상점과 협동조합을 운영합니다.",
    ...
    contact_title1:  "연락",
    contact_title2:  "하세요",
    contact_desc:    "일정, 프로그램 또는 마스지드 히다야툴라 신도 가입에 관한 정보 문의.",
    contact_address: "주소",
    contact_phone:   "전화",
    contact_email:   "이메일",
    contact_name:    "성명",
    ...
    footer_links:    "링크",
    footer_program:  "마스지드 프로그램",
    footer_copy:     "마스지드 히다야툴라. 모든 권리 보유.",
    footer_social:   "팔로우하기",

    cta_eyebrow:  "함께하기",
    cta_title1:   "마스지드를",
    cta_title2:   "함께 번성시켜요",
    cta_desc:     "마스지드 히다야툴라 신도의 일원이 되세요. 함께 공동체에 유익한 번영하는 마스지드를 만들어 갑니다.",
    cta_btn1:     "문의하기",
    cta_btn2:     "기부하기",
  },
};
